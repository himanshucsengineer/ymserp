...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All Location Code</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                        <li class="breadcrumb-item active">All Location Code</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row">
...
function refreshTable(page,search){
    ...
    if(page){
        url = `/api/location/getLocationData?page=${page}`;
    }else if(search){
        url = `/api/location/getLocationData?search=${search}`;
    }else{
        url= `/api/location/getLocationData`;
    } 
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            response.data.forEach(function(item) {
                ...
                row.append($('<td>').append(item.code));
            ...
            $('.edit-button').click(function() {
                ...
                window.location = `/location/create?id=${dataId}`
            });
