...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All Damage Code</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                        <li class="breadcrumb-item active">All Damage Code</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row">
...
function refreshTable(page,search){
    ...
    if(page){
        url = `/api/damage/getDamageData?page=${page}`;
    }else if(search){
        url = `/api/damage/getDamageData?search=${search}`;
    }else{
        url= `/api/damage/getDamageData`;
    } 
