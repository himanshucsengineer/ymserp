                        ...
                        <form id="gateinForm" novalidate="novalidate">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="consignee_gst">Consignee GST No.</label>
                                            <input type="text" class="form-control" id="consignee_gst" name="consignee_gst"  placeholder="Enter Consignee GST No.">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="consignee_name" class="form-control" readonly id="consignee_name">
                                        </div>
                                    </div>
                                </div>
                    ...
                    if(parjson.Status == 1){
                        fetch('/state.json')
                            ...
                            .then(data => {
                                ...
                                var state_code = state_data.state_code
                                ...
                                const payload = {
                                    'name':parjson.lstAppSCommonSearchTPResponse[0].tradeNam,
                                    'address':final_addr,
                                    'city':parjson.lstAppSCommonSearchTPResponse[0].pradr.addr.loc,
                                    'state':state,
                                    'pincode':parjson.lstAppSCommonSearchTPResponse[0].pradr.addr.pncd,
                                    'gst':gst,
                                    'pan':pan,
                                    'gst_state':parjson.lstAppSCommonSearchTPResponse[0].pradr.addr.stcd,
                                ...
                                $.ajax({
                                    ...
                                    success: function (responsee) {
                                        ...
                                        callout.innerHTML = `<div class="callout callout-success"><p style="font-size:13px;">${responsee.message}</p></div>`;
                                        document.getElementById('apiMessages').appendChild(callout);
                                        setTimeout(function() {
                                            callout.remove();
                                        }, 2000);

                                        $('#consignee_name').val(responsee.data.name);
                                        $('#consignee_id').val(responsee.data.id);
                                    },
