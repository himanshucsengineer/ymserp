...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">My Cash Flow</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                        <li class="breadcrumb-item active">All Cash Flow</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row">
...
function refreshTable(page,search){
    ...
    if(page){
        url = `/api/cashflow/getCashflowData?page=${page}`;
    }else if(search){
        url = `/api/cashflow/getCashflowData?search=${search}`;
    }else{
        url= `/api/cashflow/getCashflowData`;
    } 
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            response.data.forEach(function(item) {
                ...
                row.append($('<td>').append(item.bank_name));
                row.append($('<td>').append(item.person_name));
            ...
            $('.edit-button').click(function() {
                ...
                window.location = `/cashflow/create?id=${dataId}`
            });
