...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All Bank Details</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
function refreshTable(page,search){
    ...
    if(page){
        url = `/api/account/getAccountData?page=${page}`;
    }else if(search){
        url = `/api/account/getAccountData?search=${search}`;
    }else{
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            response.data.forEach(function(item) {
                ...
                row.append($('<td>').append(item.ifsc));
                row.append($('<td>').append(item.branch_name));
                row.append($('<td>').append(item.account_holder));
            ...
            $('.edit-button').click(function() {
                ...
                window.location = `/account/create?id=${dataId}`
            });
