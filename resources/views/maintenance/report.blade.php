...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Repair & Maintenance</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
function filterByDate(){
    ...
    $.ajax({
        type: "post",
        url: "/api/maintenance/filterByDateRepairDone",
        headers: {
...
function refreshTable(page,search){
    ...
    if(page){
        url = `/api/maintenance/getInspectionDataRepairDone?page=${page}`;
    }else if(search){
        url = `/api/maintenance/getInspectionDataRepairDone?search=${search}`;
    }else{
        url= `/api/maintenance/getInspectionDataRepairDone`;
    }
