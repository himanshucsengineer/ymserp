...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All Product Category</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
function refreshTable(page,search){
    ...
    if(page){
        url = `/api/product-category/getCategoryData?page=${page}`;
    }else if(search){
        url = `/api/product-category/getCategoryData?search=${search}`;
    }else{
        url= `/api/product-category/getCategoryData`;
    } 
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            response.data.forEach(function(item) {
                ...
                var image = $('<a>').attr({'href':'/uploads/category/'+item.image, 'target':'_blank'}).text("View Image");
            ...
            $('.edit-button').click(function() {
                ...
                window.location = `/product_category/create?id=${dataId}` 
            });
            ...
            $('.delete-button').click(function() {
                ...
                post('product-category/delete',data);
                refreshTable();
            });
        },
